...
L['GENERAL_DTGUILD'] = 'Full roster visibility in the confederate via data broker Guild (X), including: name, faction, level, spec, class, race, realm, guild, team, rank, zone and professions.'
...
L['CHAT_ICON'] = 'Show Icon'
L['CHAT_ICON_TOOLTIP'] = 'Show the addon icon'
