		...
		Print = {
			...
			args = {
				...
				FactoryF = {
					order = 8,
					type = 'execute',
					name = XFG.Lib.Locale['FACTORY_FRIEND'],
					func = function(info) XFG.Factories.Friend:Print() end,
				},
				FactoryL = {
					order = 9,
					type = 'execute',
					name = XFG.Lib.Locale['FACTORY_LINK'],
					func = function(info) XFG.Factories.Link:Print() end,
				},
				FactoryM = {
					order = 10,
					type = 'execute',
				...
				FactoryN = {
					order = 12,
					type = 'execute',
					name = XFG.Lib.Locale['FACTORY_NODE'],
					func = function(info) XFG.Factories.Node:Print() end,
				},
				FactoryU = {
					order = 13,
					type = 'execute',
