...
L['SETUP_CONFEDERATE_INSTRUCTIONS'] = 'The Confederate Name and Initials are required for proper setup.\n\nA collection of guilds is known as a confederate. Example, Eternal Kingdom (EK) confederate comprises seven different guilds. Enter what you want your confederate to be known as below.\n\nThe addon will use a local channel to communicate between confederate addon users of the same faction/realm if there is more than one guild on that faction/realm combination. The channel name must be unique for your realms, otherwise the addon will use GUILD channel for communication.'
