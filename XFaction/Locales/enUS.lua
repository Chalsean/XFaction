...
L['GENERAL_CONFIGURATION'] = 'Option Categories'
L['GENERAL_CHAT'] = '1. Chat - This category contains all options related to enabling/disabling/configuring guild chat, system message and login/logout for individual users.'
L['GENERAL_DATATEXT'] = '2. DataText - This category contains all options related to configuring the data brokers/text included (Guild (X), Links (X), Metrics (X)).'
L['GENERAL_NAMEPLATES'] = '3. Nameplates - This category contains options for ElvUI uOF tags and Kui nameplates.'
L['GENERAL_SETUP'] = '4. Setup - Instructions for GMs on how to configure XFaction for your guilds.'
L['GENERAL_SUPPORT'] = '5. Support - FAQ, Discord, GitHub and primary contact information.'
L['GENERAL_DEBUG'] = '6. Debug - Configure logging capabilities, user needs to have _DebugLog addon installed.'
