...
function CON:OnEnable(self, event, ...)
	...
	-- 	self.text:SetFormattedText(format('|cff00FF98%d', CON.Confederate:))
	-- end
end

hooksecurefunc(CON, 'Confederate:AddUnit', CON.OnEnable)
CON:Info(LogCategory, "Created hook for CON.Confederate.AddUnit")
...
DT:RegisterDatatext('Confederation (C)', CON.Category, events, OnEvent, OnEnable, OnClick, OnEnter)