...
function XFG:ExtractTarball(inTarball)
	...
	_UnitData:SetFaction(XFG.Factions:GetFactionByName(inTarball.Fa))
	_UnitData:SetClass(XFG.Classes:GetClass(inTarball.C))
	_UnitData:SetRace(XFG.Races:GetRace(inTarball.R))
	_UnitData:SetRealmName(XFG.Realms:GetRealm(inTarball.RN))
	_UnitData:SetGuildName(_UnitData:GetFaction(), inTarball.GN)
